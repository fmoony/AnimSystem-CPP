...
// ─────────────────────────────────────────────────────
// Tick — 每帧读取输入数据 → 直接调 StateComponent + MoverComponent
// ─────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────
// Input Action 回调 — 累积到 PendingInput
// ─────────────────────────────────────────────────────
...
void UCharacterInputComponent::OnSprintStarted(const FInputActionValue& Value)
{
	PendingInput.bSprintHeld = true;
}

void UCharacterInputComponent::OnSprintCompleted(const FInputActionValue& Value)
{
	PendingInput.bSprintHeld = false;
}

void UCharacterInputComponent::OnWalkStarted(const FInputActionValue& Value)
{
	PendingInput.bWalkHeld = true;
}

void UCharacterInputComponent::OnWalkCompleted(const FInputActionValue& Value)
{
	PendingInput.bWalkHeld = false;
}
...
void UCharacterInputComponent::OnStrafeStarted(const FInputActionValue& Value)
{
	PendingInput.bStrafeHeld = true;
}

void UCharacterInputComponent::OnStrafeCompleted(const FInputActionValue& Value)
{
	PendingInput.bStrafeHeld = false;
}
